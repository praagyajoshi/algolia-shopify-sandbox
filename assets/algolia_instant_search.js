  ...
  instant.facets.widgets.forEach(function (widget) {
    var facetWithPanel = panel({
      hidden: function (options) {
        ...
        /**
         * Replacing any "." in the class name with "\." so that querySelector
         * can work as expected. "." are supposed to be present for named tags
         * and metafield based facet names
         */
  ...
  instant.search.addWidgets([
    {
      init: function () {
        ...
        container.addEventListener("click", function (e) {
          ...
          if (collectionPage && collectionHandle) {
